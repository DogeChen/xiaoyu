...
public class HomeInfor {
     ...
     * id：设备排序
     ...
     $deviceMode = array( "switch" => "一键呼入装置","plug" => "PLUG装置", "sensor_ht" => "温度传感器", "motion" => "人体红外传感器", "magnet" => "门磁传感器","magic" => "魔方感应器", "vedio" => "视频健康器", "safemode" => "安防模式");

     sid：设备id
     temperature: 温度 25.08 格式有误 前端再改
     humidity   ：湿度
     add_date   ：添加时间
     temperatures :温度数组 [0,0,0,0,0,0,0,"2257","2306","2358","2409","2416","2459","2506","2512",0,0,0,0,0,0,0,0,0]
     ...
     * temperatures : [0,0,0,0,0,0,0,"2257","2306","2358","2409","2416","2459","2506","2512",0,0,0,0,0,0,0,0,0]
